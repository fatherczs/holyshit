...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>关键字</label>
			<input name=""  id="keywords" type="text" class="dfinput" />
			<i>关键字不超过10</i>
		</li>
		<li>
			<label>&nbsp;</label>
			<input name="" onclick="savekeywords()" type="button" class="btn" value="查询"/>
		</li>
	</ul>
</div>
<div class="rightinfo">
	<div class="tools">
		<ul class="toolbar">
			...
			<li onclick="Deletekey()"><span><img src="images/t03.png"/></span>删除</li>
