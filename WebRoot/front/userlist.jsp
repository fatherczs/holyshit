...
<head>
 <base href="<%=basePath%>">
	...
	<link rel="icon" href="front/front/images/icon.ico">
...
<body>
    ...
    <div class="header">
        <div class="header_main wrap">
            <h1><a href="index.html" target="_blank"></a><img src="front/front/images/logo-2.png"></a></h1>
            <h2>让你的闲置游起来!</h2>
    ...
    <!-- 宝贝信息 -->
     <form action="FrontUseServlet" method="post" >
    <div class="bbxx wrap">
    <div class="biaodan"><span>编号：</span><input type="text" name="id" value="${ses.u_id}" readonly="readonly" ></div>
    	<div class="biaodan"><span>昵称：</span><input type="text" name="nickname" value="${ses.u_nickname}"></div>
    	<div class="biaodan"><span>手机号：</span><input type="text" name="phonenum" value="${ses.u_phonenum}"></div>
    	<div class="biaodan"><span>生日：</span><input type="text"  name="birthday" value="${ses.u_birthday}"></div>
    	<div class="biaodan"><span>省：</span><input type="text"  name="province" value="${ses.u_province}"></div>
    	<div class="biaodan"><span>市：</span><input type="text" name="city" value="${ses.u_city}"></div>
    	<div class="biaodan"><span>区：</span><input type="text" name="district" value="${ses.u_district}"></div>
